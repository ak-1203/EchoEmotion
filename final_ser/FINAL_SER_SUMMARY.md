...
This will produce the PNG referenced above. If you prefer, I can run the script here and add the generated `confusion_matrix.png` into the repository for you.
